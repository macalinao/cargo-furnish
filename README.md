...
[![CI](https://github.com/macalinao/cargo-furnish/actions/workflows/ci.yml/badge.svg)](https://github.com/macalinao/cargo-furnish/actions/workflows/ci.yml)
...
cargo furnish check my-crate
cargo furnish check crates/my-crate
```
...
| `missing_github_badge`    | README missing the GitHub badge                                              |
...
Auto-fix everything that doesn't require user input: workspace inheritance, `[lints]` section, `readme` field removal, and doc include injection.
...
**`Cargo.toml`** — fills in missing fields and converts to `.workspace = true` where applicable.

**`README.md`** — generates a standard README with:

- Crate name heading
- crates.io, docs.rs, GitHub, and license badges
